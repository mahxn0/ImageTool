...
#xmlpath = '/media/mahxn0/DATA/dataset/label_xml/'          #源图像路径
#imgpath = '/media/mahxn0/DATA/dataset/label_img/'         #源图像所对应的xml文件路径
#rotated_imgpath = '/media/mahxn0/DATA/dataset/box/train_img/'
#rotated_xmlpath = '/media/mahxn0/DATA/dataset/box/train_xml/'
xmlpath='./test/'
imgpath='./test/'
rotated_imgpath='./img/'
rotated_xmlpath='./xml/'
for angle in (30,60,90,180,360,45,120,150,270):
